import{i as l,S as d}from"./assets/vendor-8c59ed88.js";(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))a(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const o of t.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&a(o)}).observe(document,{childList:!0,subtree:!0});function r(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function a(e){if(e.ep)return;e.ep=!0;const t=r(e);fetch(e.href,t)}})();const h="43820023 - fa202629be5215ad836dbfc98",u="https://pixabay.com/api/",f=(s="cat")=>{const i=new URLSearchParams({key:h,q:s,image_type:"photo",orientation:"horizontal",safesearch:!0});return fetch(`${u}?${i}`).then(r=>{if(!r.ok)throw new Error(r.statusText);return r.json()})},g=s=>s.map(({webformatURL:i,largeImageURL:r,tags:a,likes:e,view:t,comments:o,downloads:L})=>`<li class="gallery-item">
      ...
      </li>`).join(""),p=document.querySelector(".js-search-form");document.querySelector(".js-search-input");document.querySelector(".search-btn");const n=document.querySelector(".gallery-list"),m=document.querySelector(".loader");let c;function y(s){s.preventDefault();const i=s.target.elements.searchKeyword.value.trim();if(i===""){n.innerHTML="",s.target.reset(),l.show({message:"Sorry, there are no images matching your search query. Please try again!",position:"topRight",timeout:2e3,color:"red"});return}n.innerHTML="",m.classList.remove("is-hidden"),f(i).then(r=>{if(r.hits.length===0){l.show({message:"Sorry, there are no images for this query",position:"topRight",timeout:2e3,color:"red"}),galleryEl.innerHTML="";return}n.innerHTML=g(r.results),c&&c.destroy(),c=new d(".js-gallery a",{captionDelay:250})}).catch(r=>{console.error("Error fetching photos:",r),l.show({message:"An error occurred while fetching photos",position:"topRight",timeout:2e3,color:"red"})}).finally(()=>{s.target.reset(),m.classList.add("is-hidden")})}p.addEventListener("submit",y);
